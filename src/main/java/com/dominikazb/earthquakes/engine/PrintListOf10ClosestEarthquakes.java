...
public class PrintListOf10ClosestEarthquakes {
	...
	public TreeMap<Double, String> print10closestEarthquakes(Map<String, Coordinates> coordinatesNamesMap, String latitude1stCityString, String longitude1stCityString) {
		
		temporaryMap = new TreeMap<>();
		for(Map.Entry<String, Coordinates> entry : coordinatesNamesMap.entrySet()) {
			String place = (String) entry.getKey();
			Coordinates newCoordinates = (Coordinates) entry.getValue();
